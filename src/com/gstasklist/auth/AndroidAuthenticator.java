...
public class AndroidAuthenticator implements Authenticator {
	...
	static String CLIENT_ID = "286963497567.apps.googleusercontent.com";
...
//					auth_token = b.getString(AccountManager.KEY_AUTHTOKEN);
					auth_token = GoogleAuthUtil.getToken(this.activity, acs[i].name, SCOPE);
